              ...
              <>
                <div className="btn-container">
                  ...
                  <div className={showDropdown ? "dropdown show-dropdown" : "dropdown"}>
                    ...
                    <div className="dropdown-btn" >
                      <Link to='/invite'>
                      <svg t="1665140608220" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2545">
                    ...
                    <div className="dropdown-btn" onClick={signOut}>
                      <Link to=''>
                      <svg t="1665141200771" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2548">
